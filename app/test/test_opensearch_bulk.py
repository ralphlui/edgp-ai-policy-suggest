...
def test_opensearch_bulk_indexing():
    ...
    print("\n1️⃣ Testing OpenSearch connection...")
    try:
    ...
    print("\n3️⃣ Testing ColumnDoc creation...")
    try:
    ...
    print("\n4️⃣ Testing OpenSearchColumnStore initialization...")
    try:
    ...
    print("\n6️⃣ Testing single document upsert...")
    try:
    ...
    print("\n7️⃣ Testing bulk document upsert...")
    try:
